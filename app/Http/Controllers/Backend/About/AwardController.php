...
class AwardController extends Controller
{
	...
	{
		return view('backend.about.award.index');
		
	}

	public function getData()
	{
		$model = $this->model->select('id' , 'title' , 'image', 'created_at', 'status')->whereCategory('award');
	...
	public function getCreate()
	{
		...
		return view('backend.about.award.form', ['model' => $model,'date' => $date]);
	}
	...
	public function getUpdate($id)
	{
		...
		return view('backend.about.award.form' , [
