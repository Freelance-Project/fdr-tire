...
class FDRNewsController extends Controller
{
	...
	{
		return view('backend.news.fdrnews.index');
	...
	public function getCreate()
	{
		...
		return view('backend.news.fdrnews.form', ['model' => $model,'date' => $date]);
	}
	...
	public function getUpdate($id)
	{
		...
		return view('backend.news.fdrnews.form' , [
