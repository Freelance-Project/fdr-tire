...
class MotorBrandController extends Controller
{
	...
	{
		return view('backend.product.motorbrand.index');
	...
	public function getCreate()
	{
		$model = $this->model;
		$date = '';
		return view('backend.product.motorbrand.form', ['model' => $model,'date' => $date]);
	}
	...
	public function getUpdate($id)
	{
		...
		return view('backend.product.motorbrand.form' , [
