...
class TireCategoryController extends Controller
{
	...
	{
		return view('backend.product.tirecategory.index');
	...
	public function getCreate()
	{
		$model = $this->model;
		$date = '';
		return view('backend.product.tirecategory.form', ['model' => $model,'date' => $date]);
	}
	...
	public function getUpdate($id)
	{
		...
		return view('backend.product.tirecategory.form' , [
