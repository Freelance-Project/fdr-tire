...
class TireRimController extends Controller
{
	public function __construct()
	{
		$this->model = new TireRim;
		$this->category = 1;
	}
	...
	{
		return view('backend.product.tirerim.index');
	...
	public function getCreate()
	{
		$model = $this->model;
		$date = '';
		return view('backend.product.tirerim.form', ['model' => $model,'date' => $date]);
	}
	...
	public function getUpdate($id)
	{
		...
		return view('backend.product.tirerim.form' , [
