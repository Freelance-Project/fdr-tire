...
@section('content')
 <!-- middle -->
<div id="middle-content" class="product-detail">
	<div class="wrapper">
		...
		<section id="details">
			<div class="product-inner">
				<div class="main-product">
					<div class="img-ban">
						<img src="{{ asset(null) }}frontend/images/content/main-ban.png">
					</div>
				...
				<div class="main-desc">
					<div class="top-desc">
						...
						<div class="share-row">
							<a href="#" class="facebook"><img src="{{ asset(null) }}frontend/images/material/share.png"></a>
					...
					<div class="bottom-desc">
						...
						<div class="rowperform">
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/perform1.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/perform2.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/perform3.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/perform4.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/perform5.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/perform6.png"></a>
						</div>
						<div class="rowperform">
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/time1.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/time2.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/time3.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/time1.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/time2.png"></a>
							<a href="icons"><img src="{{ asset(null) }}frontend/images/material/time3.png"></a>
						</div>
				...
				<div class="content-Road">
					<div class="row-progrees">
						...
						<div class="progres-icon">
							<img src="{{ asset(null) }}frontend/images/material/icon-progres1.png">
						</div>
					</div><!--end.row-progress-->
					...
					<div class="row-progrees">
						...
						<div class="progres-icon">
							<img src="{{ asset(null) }}frontend/images/material/icon-progres2.png">
						</div>
					</div><!--end.row-progress-->
					...
					<div class="row-progrees">
						...
						<div class="progres-icon">
							<img src="{{ asset(null) }}frontend/images/material/icon-progres3.png">
						</div>
					</div><!--end.row-progress-->
					...
					<div class="row-progrees">
						...
						<div class="progres-icon">
							<img src="{{ asset(null) }}frontend/images/material/icon-progres4.png">
						</div>
					</div><!--end.row-progress-->


				</div><!--end.content-roas-->
		</section>
		<section id="tirelogy-section" class="section-row">
			<div class="inner-wrapper">
				<div class="title-edge">
				...
				<div class="content-overview">
					<div class="row-col">
						<div class="col2">
							<h3 class="overview-title">Keunggulan</h3>
							<ul>
								<li>Alur kembangan yang lebar dan dalam memperlancar buangan air</li>
								<li>Multistep-pattern meningkatkan kestabilan dan daya cengkram</li>
								<li>Pattern lidah api yang trendy menambah gagah tampilan motor Anda.</li>
							</ul>
						</div>
						<div class="col2">
							<h3 class="overview-title">Strong Points</h3>
							<ul>
								<li>Wide grooving pattern for better water disposal</li>
								<li>Multistep-pattern for better stability and grip</li>
								<li>The flaming pattern will boost your motor appearance.</li>
							</ul>
						</div>
					</div><!--end.row-col-->
					<a href="#" class="right downloadbrosure"></a>
