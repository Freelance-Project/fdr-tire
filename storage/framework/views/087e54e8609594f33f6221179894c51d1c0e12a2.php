...
<script type="text/javascript" charset="utf-8">
    ...
    $('document').ready(function(){
         $(".cancel-button").click(function(){
            document.location.href = '<?php echo e(\helper::urlAction("index")); ?>';
            return false;
        });
    });
    ...
    {
        var url = file_url;
        replace = "<?php echo e(env('APP_URL_REPLACE')); ?>";
	...
	function browseElfinder(param1 , param2 , param3 , param4)
	{
		...
		var urlImage = '<?php echo e(url("/backend/elfinder/php/connector_image.minimal.php")); ?>';
	...
	window.onload = function()
	{
		  ...
		  filebrowserBrowseUrl: '<?php echo e(\helper::urlAction("getElfinder")); ?>'});
	}
</script> 