	            ...
	            <div class="text-center col-md-6 col-md-offset-3">
	                <div id="imaginary_container">
	                    ...
	                    <div class="cat-search text-center">
	                    	<a href="<?php echo e(url('search/category')); ?>" class="btn btn-primary">Penelitian</a>
	                        <a href="<?php echo e(url('search/category')); ?>" class="btn btn-success">Publikasi</a>
	                        <a href="<?php echo e(url('search/category')); ?>" class="btn btn-info">Data Pendukung</a>
	                        <a href="<?php echo e(url('search/category')); ?>" class="btn btn-warning">Data Personel</a>
